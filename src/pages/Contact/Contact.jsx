...
export const Contact = () => {
  ...
  return (
    <Page header="Contact">
      <ContactWrapper>
        <ContactForm
          action="https://formspree.io/f/xjvddayg"
          method="POST"
          name="contact"
          id="contactform"
        >
        ...
        <div className="buttons">
          <div className="socials">
            ...
            <a href="mailto:abdullahsevmez@gamil.com">
              <IconButton bg={green}>
            ...
            <a
              href="https://github.com/sevmezabdullah"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://drive.google.com/file/d/10OV5DBupdi60efP_wdSej2VmH6fNYW7o/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
            >
